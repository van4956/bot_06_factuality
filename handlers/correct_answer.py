...
#         "Ваш ответ: {user_answer}\n\n"
#         "<i>Объяснение: Разрыв в образовании между мужчинами и женщинами сущест��енно сократился за последние десятилетия. "
...
ANSWER_TEXT_1 = __("""Вопрос: 1\n\nСколько девочек сегодня оканчивают начальную школу в странах с низким уровнем доходов?\n\n1) 20 процентов\n2) 40 процентов\n3) 60 процентов\n\nПравильный ответ: 60 процентов\nВаш ответ: {user_answer}\n\n<i>Объяснение: Многие думают, что доступ дево��ек к образованию в бедных странах ограничен, но это уже не так. За последние десятилетия глобальные инициативы, такие как программы ООН и ВОЗ, существенно увеличили доступ к образованию, особенно среди девочек. Сегодня большинство девочек в странах с низким уровнем доходов оканчивают начальную школу, что свидетельствует об огромных улучшениях в области образования.</i>""")

ANSWER_TEXT_2 = __("""Вопрос: 2\n\nГде живет большая часть населения мира?\n\n1) В странах с низким уровнем доходов\n2) В странах со средним уровнем доходов\n3) В странах с высоким уровнем доходов\n\nПравильный ответ: В странах со средним уровнем доходов\nВаш ответ: {user_answer}\n\n<i>Объяснение: Раньше мир действительно был разделён на «богатые» и «бедные» страны, но сейчас большая часть населения "
#         "живёт в странах со средним уровнем доходов. Это Китай, Индия и многие другие страны, где экономический рост помог миллиардам людей подняться из крайней нищеты. Большинство людей имеют доступ к базовым благам, таким как электричество, вода и образование, что подтверждает этот факт.</i>""")

ANSWER_TEXT_3 = __("""Вопрос 3:\n\nЗа последние 20 лет доля мирового населения, живущего в нищете...\n\n1) ...почти удвоилась\n2) ...осталась почти неизменной\n3) ...сократилась почти вдвое\n\nПравильный ответ: ...сократилась почти вдвое\nВаш ответ: {user_answer}\n\n<i>Объяснение: Это один из самых впечатляющих успехов последних десятилетий. Улучшения в сельском хозяйстве, глобальная торговля и международные программы помощи позволили миллиардам людей выбраться из бедности. Хотя многие всё ещё живут за чертой бедности, сокращение её уровня в два раза за 20 лет — это значительный прогресс.</i>""")

ANSWER_TEXT_4 = __("""Вопрос 4:\n\nКакова сегодня ожидаемая продолжительность жизни в мире?\n\n1) 50 лет\n2) 60 лет\n3) 70 лет\n\nПравильный ответ: 70 лет\nВаш ответ: {user_answer}\n\n<i>Объяснение: Ожидаемая продолжительность жизни резко увеличилась благодаря глобальному прогрессу в медицине, вакцинации и улучшению санитарных условий. Даже в беднейших странах средняя продолжительность жизни выросла. Это показывает, насколько быстро могут меняться условия жизни при доступе к базовым благам.</i>""")
...
ANSWER_TEXT_6 = __("""Вопрос 6:\n\nПо прогнозам ООН, к 2100 году население земного шара увеличится на 4 миллиарда человек. За счет чего это произойдет?\n\n1) Будет больше детей (до 15 лет)\n2) Будет больше взрослых (от 15 до 74 лет)\n3) Будет больше стариков (от 75 лет)\n\nПравильный ответ: Будет больше взрослых (от 15 до 74 лет)\nВаш ответ: {user_answer}\n\n<i>Объяснение: Основной прирост произойдёт за счёт увеличения числа взрослых людей, которые будут жить дольше благодаря улучшению здравоохранения. Количество детей останется стабильным, а доля пожилых людей тоже будет увеличиваться, но более медленно.</i>""")

ANSWER_TEXT_7 = __("""Вопрос 7:\n\nКак за последние 100 лет изменилось количество смертей в год, вызванных стихийными бедствиями?\n\n1) Увеличилось более чем в два раза\n2) Осталось почти неизменным\n3) Уменьшилось более чем в два раза\n\nПравильный ответ: Уменьшилось более чем в два раза\nВаш ответ: {user_answer}\n\n<i>Объяснение: Благодаря развитию технологий прогнозирования, улучшению инфраструктуры и международной помощи, количество смертей от стихийных бедствий сократилось. Сегодня мы способны з��ранее готовиться к ураганам, землетрясениям и другим катастрофам, снижая их последствия.</i>""")

ANSWER_TEXT_8 = __("""Вопрос 8:\n\nСегодня население земного шара составляет около 7 миллиардов человек. Какая карта лучше всего показывает их распределение?\n\n1) Карта I\n2) Карта II\n3) Карта III\n\nПравильный ответ: Карта I\nВаш ответ: {user_answer}\n\n<i>Объяснение: Большинство населения проживает в Азии, что делает распределение людей очень неоднородным. Около 4 миллиардов человек живут в Индии, Китае и других азиатских странах. Карта I лучше всего отражает этот факт, показывая плотное население в соответствующих регионах.</i>""")

ANSWER_TEXT_9 = __("""Вопрос 9:\n\nСколько годовалых детей в мире прививается сегодня от каких-либо болезней?\n\n1) 20 процентов\n2) 50 процентов\n3) 80 процентов\n\nПравильный ответ: 80 процентов\nВаш ответ: {user_answer}\n\n<i>Объяснение: Вопреки распространённым мифам, большинство детей в мире получают базовые прививки. Это стало возможным благодаря международным программам, таким как Глобальный альянс по вакцинам (GAVI), и поддержке со стороны ВОЗ. Эти усилия помогли уменьшить уровень детской смертности и предотвратить многие заболевания.</i>""")

ANSWER_TEXT_10 = __("""Вопрос 10:\n\nВ среднем по миру к 30 годам мужчины тратят на учебу 10 лет своей жизни. Сколько лет тратят на учебу к тому же возрасту женщины?\n\n1) 9 лет\n2) 6 лет\n3) 3 года\n\nПравильный ответ: 9 лет\nВаш ответ: {user_answer}\n\n<i>Объяснение: Разрыв в образовании между мужчинами и женщинами существенно сократился за последние десятилетия. Сегодня девочки имеют почти такие же возможности для обучения, как и мальчики, что способствует улучшению их положения в обществе.</i>""")

ANSWER_TEXT_11 = __("""Вопрос 11:\n\nВ 1996 году тигры, гигантские панды и черные носороги вошли в список вымирающих видов. Сколько из этих трёх видов сегодня находятся под угрозой исчезновения?\n\n1) Два\n2) Один\n3) Ни одного\n\nПравильный ответ: Ни одного\nВаш ответ: {user_answer}\n\n<i>Объяснение: Усилия по сохранению природы, такие как создание заповедников и борьба с браконьерством, позволили восстановить численность этих видов. Хотя угрозы полностью не исчезли, они больше не находятся на грани исчезновения, что является результатом глобальных природоохранных инициатив.</i>""")

ANSWER_TEXT_12 = __("""Вопрос 12:\n\nСколько человек в мире имеют доступ к электричеству?\n\n1) 20 процентов\n2) 50 процентов\n3) 80 процентов\n\nПравильный ответ: 80 процентов\nВаш ответ: {user_answer}\n\n<i>Объяснение: Сегодня около 80% мирового населения имеют доступ к электричеству. Это стало возможным благодаря развитию энергетической инфраструктуры, даже в отдалённых районах. Этот показатель особенно заметно улучшился в странах с низким уровнем доходов.</i>""")

ANSWER_TEXT_13 = __("""Вопрос 13:\n\nЭксперты по глобальному климату считают, что в течение следующих 100 лет средняя температура...\n\n1) ...повысится\n2) ...останется неизменной\n3) ...понизится\n\nПравильный ответ: ...повысится\nВаш ответ: {user_answer}\n\n<i>Объяснение: Из-за увеличения концентрации парниковых газов в атмосфере глобальное потепление продолжит набирать обороты. Учёные прогнозируют рост температуры, если не будут приняты меры по сокращению выбросов CO₂ и других вредных веществ.</i>""")
